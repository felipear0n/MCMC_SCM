function [geo_map, d, Ginv_elev, channel_indexes, channel_elevations, n_K, compare_elements,lithology] = prepare_inputs_for_objective_function(theta)
% Modified by Felipe May 24, 2017

[G,d,channel_indexes] = makeGForConcavity(theta);
Ginv_elev = inv(G);
